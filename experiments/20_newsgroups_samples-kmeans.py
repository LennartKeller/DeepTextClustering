...
ex = Experiment('20newsgroups_samples-kmeans')
ex.observers.append(FileStorageObserver('../results/sacred_runs/20newsgroups_samples-kmeans/'))
...
def cfg():
    ...
    result_dir = f"../results/20newsgroups_samples-kmeans/{strftime('%Y-%m-%d_%H:%M:%S', gmtime())}"
