...
ex = Experiment('trec6-bert-base')
ex.observers.append(FileStorageObserver('../results/trec6-bert-base/sacred_runs'))
...
def run(n_epochs,
    ...
    result_df.to_csv(os.path.join(result_dir, 'trec6-bert-base.csv'), index=False)
